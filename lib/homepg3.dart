...
class myhome3 extends StatefulWidget {
  ...
  @override
  _myhome3State createState() => _myhome3State();
}
          ...
          child: Center(
            child: Column(
              children: [
                //text
                SizedBox( height: 15,),
                Text('Hollandia Lacks ? ', textAlign: TextAlign.center, style: TextStyle(
                  color: Colors.white,
                  fontFamily: 'Ubuntu',
                  fontSize: 30,
                  letterSpacing: 0,
                  ...
                  child: Row(
                    ...
                    children: [
                      CircularCountDownTimer(
                        ...
                        onComplete: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>myhome4()));
                        },
                        ...
                        child: Container(
                          child: Column(
                            children: [
                              ...
                              //textoption
                              Text('Iron', textAlign: TextAlign.center, style: TextStyle(
                      ...
                      child: Container(
                        child: Column(
                          children: [
                            ...
                            //textoption
                            Text('Zinc', textAlign: TextAlign.center, style: TextStyle(
                                color: Color.fromRGBO(0, 0, 0, 1),
                                fontFamily: 'Ubuntu',
                                fontSize: 20,
                                letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
                        ...
                        child: Container(
                          child: Column(
                            children: [
                              ...
                              //textoption
                              Text('Vitamin C', textAlign: TextAlign.center, style: TextStyle(
                                  color: Color.fromRGBO(0, 0, 0, 1),
                                  fontFamily: 'Ubuntu',
                                  fontSize: 20,
                                  letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
                        ...
                        child: Container(
                          child: Column(
                            children: [
                              ...
                              //textoption
                              Text('Calcium', textAlign: TextAlign.center, style: TextStyle(
                                  color: Color.fromRGBO(0, 0, 0, 1),
                                  fontFamily: 'Ubuntu',
                                  fontSize: 20,
                                  letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
