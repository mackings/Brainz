...
class myhome4 extends StatefulWidget {
  const myhome4({Key? key}) : super(key: key);

  @override
  _myhome4State createState() => _myhome4State();
}
          ...
          child: Center(
            child: Column(
              children: [
                //text
                SizedBox( height: 15,),
                Text('Aluminium Ore ? ', textAlign: TextAlign.center, style: TextStyle(
                  color: Colors.white,
                  fontFamily: 'Ubuntu',
                  fontSize: 30,
                  letterSpacing: 0,
                  ...
                  child: Row(
                    ...
                    children: [
                      CircularCountDownTimer(
                        ...
                        onComplete: (){
                           Navigator.push(context, MaterialPageRoute(builder: (context)=>myhome5()));
                        },
                        ...
                        child: Container(
                          child: Column(
                            children: [
                              ...
                              //textoption
                              Text('Bauxite', textAlign: TextAlign.center, style: TextStyle(
                      ...
                      child: Container(
                        child: Column(
                          children: [
                            ...
                            //textoption
                            Text('Silicon', textAlign: TextAlign.center, style: TextStyle(
                                color: Color.fromRGBO(0, 0, 0, 1),
                                fontFamily: 'Ubuntu',
                                fontSize: 20,
                                letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
                        ...
                        child: Container(
                          child: Column(
                            children: [
                              ...
                              //textoption
                              Text('Magnesium', textAlign: TextAlign.center, style: TextStyle(
                                  color: Color.fromRGBO(0, 0, 0, 1),
                                  fontFamily: 'Ubuntu',
                                  fontSize: 20,
                                  letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
                        ...
                        child: Container(
                          child: Column(
                            children: [
                              ...
                              //textoption
                              Text('Silica', textAlign: TextAlign.center, style: TextStyle(
                                  color: Color.fromRGBO(0, 0, 0, 1),
                                  fontFamily: 'Ubuntu',
                                  fontSize: 20,
                                  letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
