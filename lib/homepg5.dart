import 'package:brains/end.dart';
...
class myhome5 extends StatefulWidget {
  const myhome5({Key? key}) : super(key: key);

  @override
  _myhome5State createState() => _myhome5State();
}

class _myhome5State extends State<myhome5> {
  @override
          ...
          child: Center(
            child: Column(
              children: [
                //text
                SizedBox( height: 15,),
                Text('The Fastest Animal ? ', textAlign: TextAlign.center, style: TextStyle(
                  color: Colors.white,
                  fontFamily: 'Ubuntu',
                  fontSize: 30,
                  letterSpacing: 0,
                        ...
                        child: Container(
                          child: Column(
                            children: [
                              ...
                              //textoption
                              Text('Tiger', textAlign: TextAlign.center, style: TextStyle(
                      ...
                      child: Container(
                        child: Column(
                          children: [
                            ...
                            //textoption
                            Text('Cheetah', textAlign: TextAlign.center, style: TextStyle(
                                color: Color.fromRGBO(0, 0, 0, 1),
                                fontFamily: 'Ubuntu',
                                fontSize: 20,
                                letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
                        ...
                        child: Container(
                          child: Column(
                            children: [
                              ...
                              //textoption
                              Text('Horse', textAlign: TextAlign.center, style: TextStyle(
                                  color: Color.fromRGBO(0, 0, 0, 1),
                                  fontFamily: 'Ubuntu',
                                  fontSize: 20,
                                  letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
